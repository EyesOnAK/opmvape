...
vape.Libraries.bedwarsbrain = loadstring(downloadFile('catsix/libraries/bedwarsbrain.lua'), 'bedwarsbrain')()
vape.Libraries.bedwarscontroller = loadstring(downloadFile('catsix/libraries/bedwarscontroller.lua'), 'bedwarscontroller')()
vape.Libraries.bedwarsadapter = loadstring(downloadFile('catsix/libraries/bedwarsadapter.lua'), 'bedwarsadapter')()
...
run(function()
	...
	RegionLock = vape.Categories.Utility:CreateModule({
		Name = 'RegionLock',
		Function = function(callback)
			writefile('catsix/profiles/regionlock.txt', tostring(callback))
	...
	task.spawn(function()
		...
		local last = isfile('catsix/profiles/regionlock.json') and readfile('catsix/profiles/regionlock.json')
		...
		repeat
			if vape.Loaded then
				...
				if encoded ~= last then
					last = encoded
					writefile('catsix/profiles/regionlock.json', encoded)
				end
			end
			task.wait(1)
		until vape.Loaded == nil
