...
run(function()
	...
	BulletTracers = vape.Legit:CreateModule({
		Name = 'BulletTracers',
		Category = 'Game',
		Icon = getvapeasset('opmsix/assets/new/legit_bullettracers.png'),
		Function = function(callback)
			if callback then
...
run(function()
	...
	HitSound = vape.Legit:CreateModule({
		Name = 'HitSound',
		Category = 'Game',
		Icon = getvapeasset('opmsix/assets/new/legit_hitsound.png'),
		Function = function(callback)
			if callback then
				local played
...
run(function()
	...
	KillSound = vape.Legit:CreateModule({
		Name = 'KillSound',
		Category = 'Game',
		Icon = getvapeasset('opmsix/assets/new/legit_killsound.png'),
		Function = function(callback)
			if callback then
