...
run(function()
	...
	function whitelist:announce(text)
		...
		if success then
			return sendToast({
				toastTitle = text,
				iconImage = getvapeasset('opmsix/assets/new/vape.png'),
				swipeUpDismiss = true,
		...
		icon.Image = getvapeasset('opmsix/assets/new/vape.png')
	...
	function whitelist:update(first)
		...
		if not first or whitelist.textdata ~= whitelist.olddata then
			if not first then
				whitelist.olddata = isfile('opmsix/profiles/whitelist.json') and readfile('opmsix/profiles/whitelist.json') or nil
			end
			...
			if whitelist.textdata ~= whitelist.olddata then
				...
				pcall(function()
					writefile('opmsix/profiles/whitelist.json', whitelist.textdata)
				end)
			end
		end
	end
...
run(function()
	...
	local function Added(ent)
		...
		arrow.Visible = false
		arrow.Image = getvapeasset('opmsix/assets/new/arrowmodule.png')
...
run(function()
	...
	Radar = vape:CreateOverlay({
		Name = 'Radar',
		Icon = getvapeasset('opmsix/assets/new/radaricon.png'),
...
run(function()
	...
	SessionInfo = vape:CreateOverlay({
		Name = 'Session Info',
		Icon = getvapeasset('opmsix/assets/new/textguiicon.png'),
	...
	Hide = SessionInfo:CreateTextList({
		...
		Icon = getvapeasset('opmsix/assets/new/blockedicon.png'),
		Tab = getvapeasset('opmsix/assets/new/blockedtab.png'),
